...
const SideBar: React.FC<{ isDark: boolean }> = ({ isDark }) => {
  ...
  return (
    <section
      className={` tablet:hidden tablet900:flex-row  tablet900:h-[80px] tablet900:w-[100vw] flex flex-col justify-start items-start min-w-[240px] w-[260px] h-full tablet900:top-0 relative ${
        isDark ? "tablet900:bg-DBg" : "tablet900:bg-LBg"
      }`}
    >
      <div
        className={`pt-[4rem] tablet900:pt-0 flex flex-col tablet900:w-[100vw] tablet900:min-w-[0px] tablet900:min-h-[auto] justify-start items-start gap-3 w-full left-1  sticky top-8 min-h-[100vh] tablet900:relative ${
          isDark ? "bg-DBg" : "bg-LBg"
        }`}
      >
        <div className="flex w-full flex-col justify-start items-start gap-3 tablet900:justify-between tablet900:flex-row tablet900:pt-0 tablet900:gap-[20px]">
